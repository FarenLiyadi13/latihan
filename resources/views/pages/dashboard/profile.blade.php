                    ...
                    <form action="{{route('member.profile.update',[Auth::user()->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        <div class="flex items-center mt-1">
                                            {{-- {{dd(auth()->user()->detail_user()->first())}} --}}
                                            @if ($detail->photo != NULL)
                                                <img src="{{url(Storage::url($detail->photo))}}" alt="photo-profile" class="rounded-full">
                                            @else
                                            ...
                                            <a href="{{route('member.delete.photo.profile')}}" type="button" class="px-3 py-2 ml-5 text-sm font-medium leading-4 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" onclick="return confirm('are you sure want to delete your photo?')">
                                                Delete
                                            </a>
                                    ...
                                    <div class="md:col-span-6 lg:col-span-3">
                                        ...
                                        <input placeholder="Your role" type="text" name="role" id="role" autocomplete="role" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{$detail->role ??''}}" required>
                                        @if ($errors->has('role'))
                                    ...
                                    <div class="md:col-span-6 lg:col-span-3">
                                        ...
                                        <input placeholder="Alex.jones@gmail.com" type="text" name="email" id="email" autocomplete="email" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                    ...
                                    <div class="md:col-span-6 lg:col-span-3">
                                        ...
                                        <input placeholder="Your phone number" type="number" name="contact_number" id="contact_number" autocomplete="contact_number" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{$detail->contact_number ?? ''}}" required>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <textarea placeholder="Enter your biography here.." type="text" name="biography" id="biography" autocomplete="biography" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" rows="4">{{$detail->biography ?? ''}}
                                        </textarea>
                            ...
                            <div class="px-4 py-3 text-right sm:px-6">
                                <a href="{{route('member.dashboard.index')}}" type="button" class="inline-flex justify-center px-4 py-2 mr-4 text-sm font-medium text-gray-700 bg-white border border-gray-600 rounded-lg shadow-sm hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300" onclick="return confirm('are you sure want to cancel this action? ')">
                                    Cancel
                                </a>
