            ...
            @endif --}}
                <div class="relative p-6 flex-auto mx-10">
                    <div class="mb-4">
                        ...
                        <input class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="email" type="text" placeholder="name@domain.com" required autofocus name="email">
                    ...
                    <div>
                        ...
                        @if ($errors->has('password'))
                            <p class="text-red-500 mb-3 text-sm error">{{ $errors()->first('password') }}</p>
                        @endif
                    </div>
