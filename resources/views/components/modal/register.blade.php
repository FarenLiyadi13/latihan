        ...
        <form action="{{route('register')}}" method="POST">
            ...
            <div class="relative p-6 flex-auto mx-10">
                <div class="mb-4">
                    ...
                    <input name="name" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="name" type="text" placeholder="Your fullname" required autofocus>
                    @if ($errors->has('name'))
                ...
                <div class="mb-4">
                    ...
                    <input  class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="email" type="email" placeholder="name@domain.com" required name="email">
                    @if ($errors->has('email'))
