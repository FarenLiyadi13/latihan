...
class LandingController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $thumbnails = ThumbnailService::where('service_id', $id)->get();
        ...
        return view('pages.landing.detail', compact('service', 'thumbnails', 'advantage_user', 'advantage_service', 'tagline'));
    }
    public function booking($id)
    {
        ...
        // validasi booking
        if ($buyer_id == $service->users_id) {
            // return redirect()->back()->with('error', 'You can not book your own service');
