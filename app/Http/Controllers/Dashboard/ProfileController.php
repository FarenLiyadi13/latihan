...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($user->id);
        $detail = DetailUser::where('users_id', $user->id)->first();
        // dd($detail);
        // dd($user);
        $experience_user = ExperienceUser::with('detail_user')->where('detail_user_id', $user->id)->orderBy('id', 'asc')->get();

        return view('pages.dashboard.profile', compact('user', 'experience_user', 'detail'));
    }
    ...
    public function update(UpdateProfileRequest $request_profile, UpdateDetailUserRequest $request_detail_user)
    {
        ...
        // dd($get_photo);
        // delete file foto lama dari storage
